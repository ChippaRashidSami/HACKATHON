...
In our [basic-world.world](/sim-examples/gazebo-examples/world-files/basic-world.world) file, we define:
...
For a more detailed example, see our [detailed-physics-world.world](/sim-examples/gazebo-examples/world-files/detailed-physics-world.world) which demonstrates:
...
Robots in Gazebo are defined as models with links and joints. Our [simple humanoid](/sim-examples/gazebo-examples/humanoid-models/simple-humanoid.urdf) example demonstrates:
